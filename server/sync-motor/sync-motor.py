        ...
        try:
            ...
            while self.running:
                try:
                    ...
                    peer_ip = addr[0]
                    peer_port = announcement.get("listen_port", self.listen_port)  # Puerto TCP real, NO el UDP efímero

                    print (f"[{self.device_id}] 📨 Anuncio de {device_id} con IP {peer_ip} y puerto TCP {peer_port} recibido")
